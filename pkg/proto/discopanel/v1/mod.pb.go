...
const file_discopanel_v1_mod_proto_rawDesc = "" +
	"\n" +
	"\x17discopanel/v1/mod.proto\x12\rdiscopanel.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc1\x03\n" +
	"\x03Mod\x12\x0e\n" +
	...
	"\bicon_url\x18\x0e \x01(\tR\aiconUrl\".\n" +
